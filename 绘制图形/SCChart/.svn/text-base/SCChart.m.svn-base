...
-(id)initwithSCChartDataFrame:(CGRect)rect withSource:(id<SCChartDataSource>)dataSource
{
    return [self initwithSCChartDataFrame:rect withSource:dataSource withStyle:SCChartLineStyle];
}
